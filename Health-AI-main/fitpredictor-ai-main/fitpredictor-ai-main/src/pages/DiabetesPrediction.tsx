  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Diabetes Risk Assessment</h1>
        <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
          Complete the form below to receive a personalized diabetes risk assessment based on your health data.
        </p>
      </div>
